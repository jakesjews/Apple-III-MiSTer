...
verilator --cc --exe --build -j 4 -O2 --top-module core_tb \
  ...
  sim/coretest/dpram_model.sv rtl/disk/floppy_track.sv rtl/disk/dsk_nibblizer.sv \
  rtl/disk/drive_ii.v rtl/apple3_mmu.sv rtl/apple3_timing.sv rtl/apple3_ram.sv \
