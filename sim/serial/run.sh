...
verilator --cc --exe --build -j 4 -O2 --top-module core_tb \
  ...
  rtl/apple3_video.sv rtl/apple3_composite.sv rtl/apple3_slots.sv rtl/apple3_slot_rom.sv rtl/cards/apple3_block_card.sv rtl/apple3_core.sv sim/serial/main.cpp -o Vcore_tb
