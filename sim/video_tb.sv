...
module video_tb;
	...
	begin
		h_state = state; state_dot = dot; h_count = state * 14 + dot; #1;
	end
	endtask
	...
	initial begin
		...
		v_count = 0; h_count = 600; video_mode = 0; #1;
		...
		video_mode = 4'b1000; h_count = 600; #1;
		if (ram_addr !== 18'h00400) $fatal(1, "graphics prefetch address=%05x", ram_addr);

		screen_enable = 0; h_count = 0; h_state = 0; state_dot = 0; #1;
